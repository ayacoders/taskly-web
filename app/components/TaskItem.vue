...
<template>
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-primary-500 transition-all duration-300">
        <!-- Header -->
        <div class="p-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    />
                    <h3 class="text-lg font-medium" :class="{ 'line-through text-gray-400': task.status }">
                        {{ task.title }}
                    </h3>
                </div>
                <span 
